...
**Status:** `DISABLED — NOT_RUNNABLE_YET_BOOTSTRAP_ONLY`

> This checklist is not yet active. Do not attempt to run the schema workflow after PR #1. The checklist items below are provided for reference only and will be enabled when the later PRs are merged.
...
- [ ] Confirm the governing doctrine (PR #2) has been merged
- [ ] Confirm the truth-pack reference (PR #3) has been merged
